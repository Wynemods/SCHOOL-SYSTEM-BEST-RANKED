...
async function testDebugServer() {
    ...
    try {
        ...
        const memberBooksResponse = await fetch('http://localhost:3001/api/member-books');
        ...
        const addBookResponse = await fetch('http://localhost:3001/api/member-books', {
            method: 'POST',
        ...
        const memberBooksResponse2 = await fetch('http://localhost:3001/api/member-books');
